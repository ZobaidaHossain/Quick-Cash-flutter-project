...
class tPinPage extends StatefulWidget {
  const tPinPage({Key? key, required this.menu}) : super(key: key);

  final HomeMenu menu;

  @override
  State<tPinPage> createState() => _tPinPageState();
}

class _tPinPageState extends State<tPinPage> {
