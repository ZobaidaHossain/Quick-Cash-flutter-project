...
enum HomeMenu {
  ...
  cashOut('Cash Out', 'assets/cash_out.jpg', SendMoneyWidget()),
  topUp('Top-up', 'assets/mobile_recharge.jpg', SendMoneyWidget()),
  payment('Payment', 'assets/make_payment.jpg', SendMoneyWidget()),

  addMoney('Add Money', 'assets/add_money.jpg', bank()),
  payBill('Pay Bill', 'assets/pay_bill.jpg', paybill()),
  tickets('Tickets', 'assets/tickets.jpg', ticket()),
  more('More', 'assets/more.jpg', Text(AppText.placeholder)),

  //my bKash
  topUps('Opshory', 'assets/mobile_recharge.jpg', Text(AppText.placeholder)),
