            ...
            child: Column(
              children: [
                Row(
                  children: [
                    Padding(
                      padding: EdgeInsets.fromLTRB(12, 8, 4, 24),
                      child: Text(
                        "Confirm to ",
                        style: AppTheme.dialogconfirmText,
                      ),
                    ),
                    Expanded(
                        child: Padding(
                      padding: EdgeInsets.fromLTRB(0, 8, 12, 24),
                      child: Text(
                        "Send Money",
                        style: AppTheme.dialogconfirmTextBold,
                      ),
                    ))
                  ],
                ),
                Padding(
                  padding: const EdgeInsets.fromLTRB(18, 12, 12, 24),
                  child: Row(
                    children: [
                      Image.asset(
                        "assets/user.png",
